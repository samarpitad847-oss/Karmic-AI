...
```
karmic-ai/
├── frontend/          ← Open index.html in browser to run
│   ├── index.html
│   ├── signup.html
│   ├── dashboard.html
│   ├── admin.html
...
4. Create account → lands on dashboard.html

### Admin view
1. On signup.html — click the dashed purple box **"I am a Hospital Admin"**
2. OR on login — toggle **"Log in as Hospital Admin"**
3. → Redirects to admin.html (anonymised dept-level dashboard)

### Women Support
1. Login as any user
2. On dashboard.html sidebar → toggle **"Women-Safe Mode"**
3. Banner appears with **"Open Women Support →"** button
4. Sidebar shows **"👩‍⚕️ Women Support"** link → women.html
...
Frontend auto-calls /api/* endpoints. Works in demo mode without backend too.
